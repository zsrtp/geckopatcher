...
pub struct Config {
    ...
    pub src: Src,
    #[serde(default)]
    pub files: HashMap<RelativePathBuf, RelativePathBuf>,
    pub build: Build,
...
pub struct Diffs {
    ...
    pub deletions: Vec<RelativePathBuf>,
